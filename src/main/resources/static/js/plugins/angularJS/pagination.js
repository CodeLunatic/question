...
angular.module('pagination', []).directive('tmPagination', [function () {
    return {
        ...
        template: '<div class="page-list">' +
            ...
            '第<input type="text" style="display: inline-block;" class="form-control" ng-model="jumpPageNum"  ng-keyup="jumpToPage($event)"/>页 ' +
            '每页<select  style="display: inline-block; width: 7rem; height: 2.8rem;" class="form-control" ng-model="conf.itemsPerPage" ng-options="option for option in conf.perPageOptions "></select>' +
